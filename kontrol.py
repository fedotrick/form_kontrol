    ...
    def save_data(self):
        try:
            ...
            data = [
                ...
                # Окончательный брак в том же порядке, как в форме
                ...
                self.контролер3_input.currentText()  # Контролер 3 в конце
            ]
            ...
            headers = [
                ...
                'Доработка_питатель', 'Доработка_корона',
                'Доработка_смещение',
                # Заголовки окончательного брака в том же порядке
                ...
                'Окончательный_брак_нарушение_маркировки', 'Окончательный_брак_неслитина',
                'Окончательный_брак_прочее',
                'Контролер3'  # Контролер 3 в конце
            ]
